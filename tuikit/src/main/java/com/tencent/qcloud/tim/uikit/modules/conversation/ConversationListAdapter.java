...
public class ConversationListAdapter extends IConversationAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ConversationInfo.TYPE_CUSTOM) {
            ...
            ConversationCommonHolder commonHolder= (ConversationCommonHolder) holder;

            if (style){
                commonHolder.titleText.setTextColor(parent.getResources().getColor(R.color.text_color));
                commonHolder.timelineText.setTextColor(parent.getResources().getColor(R.color.text_gray_color));
            }else {
                commonHolder.titleText.setTextColor(parent.getResources().getColor(R.color.text_color));
                commonHolder.timelineText.setTextColor(parent.getResources().getColor(R.color.text_gray_color));
            }
    ...
    public void setItemStyle(boolean style){
       this.style=style;
    }
