...
//            leftItemLayout.setBackgroundResource(R.drawable.bg_message_item_top);
//        } else {
//            leftItemLayout.setBackgroundResource(R.drawable.bg_message_item);
//        }
...
//            conversationIconView.setIconUrls(urllist);
            conversationIconView.setCircleImage(conversation.getIconUrl());
            urllist.clear();
        }
