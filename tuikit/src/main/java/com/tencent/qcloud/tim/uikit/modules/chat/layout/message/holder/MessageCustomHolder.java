...
public class MessageCustomHolder extends MessageContentHolder implements ICustomMessageViewGroup {
    ...
    public void layoutViews(MessageInfo msg, int position) {
        ...
        if (msg.isSelf()) {
            msgContentLinear.setBackgroundResource(R.drawable.ic_private_give_gift_my_bg);
        } else {
            msgContentLinear.setBackgroundResource(R.drawable.ic_private_give_gift_hi_bg);
        }
