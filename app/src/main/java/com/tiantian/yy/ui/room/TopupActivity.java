...
import com.tiantian.yy.alipay.PayResult;
import com.tiantian.yy.base.MyBaseActivity;
import com.tiantian.yy.bean.TopupListBean;
...
import com.tiantian.yy.ui.mine.TopupHistoryActivity;
import com.tiantian.yy.ui.room.adapter.BottomShowRecyclerAdapter;
import com.tiantian.yy.ui.room.adapter.TopupListAdapter;
...
//                    }
                    ...
                    if (listTop.size() > 1) {
                        if (topupListBean.getData().getState() == 1) { //首冲
                            ...
                            tvTopuponeTopup.setText("首充送" + listTop.get(0).getX() + "甜甜圈");
                        }
                        listTop.remove(0);
