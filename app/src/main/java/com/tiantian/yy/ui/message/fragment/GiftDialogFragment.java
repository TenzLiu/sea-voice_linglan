package com.tiantian.yy.ui.message.fragment;
...
import com.tiantian.yy.dialog.MyPacketNumDialog;
...
import com.tiantian.yy.ui.message.adapter.GiftChatAdapter;
import com.tiantian.yy.ui.room.TopupActivity;
import com.tiantian.yy.ui.room.adapter.GiftNumberListAdapter;
import com.tiantian.yy.ui.room.adapter.GiftUserListAdapter;
import com.tiantian.yy.ui.room.adapter.ViewPagerAdapter;
        ...
        HttpManager.getInstance().post(Api.getUserMoney, map, new MyObserver(context) {
            ...
            public void success(String responseString) {
                ...
                if (getOneBean.getCode() == Api.SUCCESS) {
                    ...
                    tvGoldGift.setText(getOneBean.getData().getGold() + "甜甜圈");
                } else {
...
//        getDialog().getWindow().setLayout(WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.WRAP_CONTENT);
    ...
    private void iniData() {
        ...
        tvGoldGift.setText(goldYou + "甜甜圈");
